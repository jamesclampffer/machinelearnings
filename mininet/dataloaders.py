...
class MultiDatasetLoader:
    ...
    Most training is on an H100, so not much resource tuning for other platforms.
    """
    ...
    def __init__(self, dataset_name, transformfactory, batch_size, root='./data', download=True):
        self.dataset_name = dataset_name.lower()
        self._batch_size = batch_size
        self.download = download

        # Deficed from dataset, need to better wrap this
        ...
        if self.dataset_name == 'cifar10':
            ...
            self.native_dimensions = (3, 224, 224)
    ...
    def get_train_loader(self):
        return DataLoader(self.train_set, batch_size=self.batch_size, shuffle=True, prefetch_factor=64, pin_memory=True, persistent_workers=True, num_workers=16)

    def get_val_loader(self):
        return DataLoader(self.val_set, batch_size=self.batch_size, shuffle=False, prefetch_factor=64, pin_memory=True, persistent_workers=True, num_workers=16)
